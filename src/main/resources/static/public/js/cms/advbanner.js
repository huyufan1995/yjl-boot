$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '文字描述', name: 'imagePath', index: 'image_path', width: 80, sortable: false}, 			
...
//	            	}else if(row.type == 'advs'){ 
//	            		return "<span class='label label-warning'>广告位</span>";
//	            	}else{
...
//			{ label: '序号', name: 'sortNum', index: 'sort_num', width: 80 }, 			
			{ label: '小程序appid', name: 'bannerVal', index: 'banner_val', width: 80 },
			{ label: '小程序跳转地址', name: 'appPath', index: 'app_path', width: 80 }, 
			{
                label: '操作', name: '', index: 'operate', width: 100, align: 'left', sortable: false,
                formatter: function (value, options, row) {
                	var dom = "<button type='button' class='ivu-btn ivu-btn-primary' onclick='editAdvs("+row.id+")'><i class='ivu-icon ivu-icon-minus'></i><span>编辑</span></button>&nbsp;";
