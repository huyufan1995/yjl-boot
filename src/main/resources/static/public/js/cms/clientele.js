	...
	methods: {
		...
		reload: function (event) {
			...
			$("#jqGrid").jqGrid('setGridParam',{ 
				postData:{"id": vm.q.id,"functionaryName":vm.q.functionaryName, "sdate":vm.q.sdate,"company":vm.q.company,"name":vm.q.name,"mobile":vm.q.mobile, "edate":vm.q.edate},
                page:page
            }).trigger("reloadGrid");
		},
		formateDate (val){
