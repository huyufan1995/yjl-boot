        ...
        colModel: [
			...
			},
			{
                ...
                formatter: function (value, options, row) {
					...
					dom += "<button type='button' class='ivu-btn ivu-btn-error' onclick='showVipImg("+row.id+")'><i class='ivu-icon ivu-icon-minus'></i><span>生成VIP二维码</span></button>&nbsp;";
					return dom;
                }
            }
        ],
