...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			this.$refs['informationType'].validate((valid) => {
                if (valid) {
                	var url = vm.informationType.id == null ? "../informationstype/save" : "../informationstype/update";
        			$.ajax({
        				type: "POST",
        			    url: url,
        			    contentType: "application/json",
		...
		getInfo: function(id){
			//$.get("../informationtype/info/" + id, function(r){
