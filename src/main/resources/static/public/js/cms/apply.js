$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '报名人数', name: 'applyCount', index: 'apply_count', width: 80 },
			...
			{ label: '报名数据', name: 'images', index: 'images', width: 80,
			...
			{ label: '表单标签', name: 'items', index: 'items', width: 80 },
			...
			{ label: '地址', name: 'address', index: 'address', width: 80 },
			{
                ...
                formatter: function (value, options, row) {
					...
					dom += "<button type='button' class='ivu-btn ivu-btn-error' onclick='showApplyImg("+row.id+")'><i class='ivu-icon ivu-icon-minus'></i><span>查看二维码</span></button>&nbsp;";
					return dom;
                }
            }
        ],
